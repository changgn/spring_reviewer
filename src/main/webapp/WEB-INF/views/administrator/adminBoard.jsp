	...
	<head>
		<style>
			* { margin:0; padding:0; }
			...
			.change{ margin: 10; padding: 0; width: 60px; height: 20px; text-align: center; cursor: pointer; float: left;}
			...
			.Sort_Menu{ margin: 10; padding: 0; width: 400px; text-align: right; cursor: pointer; float: right;}
